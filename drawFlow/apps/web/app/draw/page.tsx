          ...
          <DropdownMenuContent align="start">
            ...
            >
              ...
              <div className="flex items-center gap-1 rounded-full bg-muted px-1 py-1">
                <button
                  type="button"
                  className={`h-7 w-7 rounded-full flex items-center justify-center ${theme === "light" ? "bg-[#c7f3e2] text-black" : "opacity-70"
                    }`}
                ...
                <button
                  type="button"
                  className={`h-7 w-7 rounded-full flex items-center justify-center ${theme === "dark" ? "bg-[#c7f3e2] text-black" : "opacity-70"
                    }`}
                ...
                <button
                  type="button"
                  className={`h-7 w-7 rounded-full flex items-center justify-center ${theme === "system" ? "bg-[#c7f3e2] text-black" : "opacity-70"
                    }`}
